				...
				<div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
					...
					>
						<img
							...
							alt="logo"
						/>
						<span className="self-center text-2xl hidden md:inline font_secondary tracking-wider text-gray-900 dark:text-gray-100 font-semibold whitespace-nowrap">
							TokenPalace
						</span>
					</NavLink>
					...
					{/* toggled menu */}
					<div
						className={`bg-slate-400 md:bg-transparent z-10 dark:bg-slate-900 dark:text-slate-100 text-slate-900 items-center ${
							menuToggled ? "" : "hidden"
