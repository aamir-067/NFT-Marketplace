...
import { resetWeb3 } from '../features';
            ...
            <nav className=" border-gray-200 dark:bg-gray-900">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <NavLink to={""} className="flex items-center">
                        <img src="https://bafybeigj25ax2rek4dygzjd4aw6vvf4vaklfu2jtrf4hw7dmcpy5jeaeta.ipfs.dweb.link/" className="h-8 mr-3" alt="logo" />
                    ...
                    <div className="flex items-center gap-x-4 md:order-2">
                        <p className='font-bold hidden lg:block text-sm'>{signer && `${[...signer.address].slice(0, 7).join('')}....${[...signer.address].slice(37, 42).join('')}`}</p>
                        <button
                            type="button"
